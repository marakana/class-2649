...
namespace com_intel_lognative {

	static void log(JNIEnv *env, jclass clazz, jint priority, jstring tag, jstring msg) {
...
using namespace com_intel_lognative;
...
extern "C" jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    if (vm->GetEnv(reinterpret_cast<void**>(&env), JNI_VERSION_1_6) != JNI_OK) {
        ...
        jclass clazz = env->FindClass("com/intel/lognative/LogLib");
        if (clazz) {
